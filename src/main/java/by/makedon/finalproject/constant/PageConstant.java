package by.makedon.finalproject.constant;
...
public class PageConstant {
    ...
    public static final String FORWARD_PAGE = "/jsp/forwardPage.jsp";
    ...
    public static final String DELETE_USER_PAGE = "/WEB-INF/security/admin/deleteUserPage.jsp";
    public static final String CHANGE_USER_DATA_PAGE = "/WEB-INF/security/user/changeUserDataPage.jsp";

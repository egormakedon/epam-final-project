...
public class Page {
    ...
    public static final String SEND_FORM = "/WEB-INF/security/user/fillFormPage.jsp";
    public static final String SHOW_FORM = "/WEB-INF/security/user/showFormPage.jsp";
    ...
    public static final String SHOW_ENROLLEES = "/WEB-INF/security/admin/showEnrollees.jsp";
    public static final String SHOW_SPECIALITYS = "/WEB-INF/security/admin/showSpecialitys.jsp";
    //---------- ADMIN ----------
}

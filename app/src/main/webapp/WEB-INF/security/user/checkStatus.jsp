...
<head>
    ...
    <fmt:message bundle="${locale}" key="text.checkstatus.title" var="title"/>
    ...
    <fmt:message bundle="${locale}" key="text.checkstatus.statement" var="statement"/>
    <fmt:message bundle="${locale}" key="text.checkstatus.yourplace" var="your_place"/>
...
<h1> ${your_place} ${requestScope.place}</h1>

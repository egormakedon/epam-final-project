...
<head>
    ...
    <fmt:message bundle="${locale}" key="text.changeemail.title" var="title"/>
    ...
    <div id="content">
        ...
        <form class="login" action="/Controller" method="post">
            ...
            <p>
                ...
                <input type="text" name="newemail" id="login" pattern="^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)$" required>
                <span class="form_error">example@site.com</span>
            </p>
            <p class="login-submit">
                <button type="submit" class="login-button">${change_email}</button>
            </p>
        </form>
    </div>
</div>
